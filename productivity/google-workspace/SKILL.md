...
| `ModuleNotFoundError: hermes_constants` | Run setup from hermes-agent dir: `cd ~/.hermes/hermes-agent && PYTHONPATH=~/.hermes/hermes-agent python $GSETUP ...` |
| `ModuleNotFoundError` | Run `$GSETUP --install-deps` |
| himalaya `tls handshake eof` with Gmail | Use Python imaplib instead — himalaya v1.1.0 rustls TLS has known Gmail compatibility issues. App Password is 16 chars, no spaces. |
